        ...
        <div className="wrapper home">
            ...
            <Carousel className="carusele-block" interval="3000">
                <Carousel.Item className="carusele_img-block">
                    <img className="d-block carusele_img w-100" src={office_1} alt="First slide" />
                    <Carousel.Caption>
                ...
                <Carousel.Item className="carusele_img-block">
                    <img className="d-block carusele_img w-100" src={office_2} alt="Third slide" />
                    <Carousel.Caption>
                ...
                <Carousel.Item className="carusele_img-block">
                    <img className="d-block carusele_img w-100" src={office_3} alt="Fourth slide" />
                    <Carousel.Caption>
            ...
            <div className="content-container">
                <img className="home_1_img" src={home_1} alt="home_1" />
                <h3>О компании TSV-print:</h3>
                <h5>
                    TSV-print – это команда специалистов, готовых в самые сжатые сроки оказать Вам помощь во всех
                    возникающих вопросах касающихся Вашей офисной или домашней печатной техники (оргтехники). У нас Вы
                    можете получить бесплатную консультацию по её обслуживанию, эксплуатации или приобретению по
                    ...
                    проведения более сложных ремонтных работ, прошивки (расчиповки), диагностики неисправностей, — мы
                    своими силами доставляем вашу технику в нашу мастерскую и обратно. В TSV-print мы используем только
                    проверенные оригинальные материалы, что дает возможность обеспечить отличное качество печати, свести
                    к минимуму частоту необходимых замен узлов и деталей. На весь спектр оказанных услуг в обязательном
                    порядке предоставляется гарантия.
                </h5>
            </div>
        </div>
    );
